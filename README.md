...
| --- | --- |
| [`MVNT4.2 - music_to_3d_dance.json`](./workflows/MVNT4.2%20-%20music_to_3d_dance.json) | `MVNT4.2: music_to_3d_dance` featured workflow: music -> animated 3D dance GLB, Comfy 3D preview, and optional 670x400 MP4 reference video. |
...
2. Load [`workflows/MVNT4.2 - music_to_3d_dance.json`](./workflows/MVNT4.2%20-%20music_to_3d_dance.json), or create this chain manually:
